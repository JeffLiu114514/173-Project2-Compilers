 ...
 * focs_11_27.c
 *
 * FOCS Fig. 11.24(a) Auxiliary functions for recursive-descent parser.
 * FOCS Fig. 11.24(b) Function to construct parse trees for strings of balanced parentheses.
 *
